    ...
    if 2 < len(message.text) < 100:    
        ...
        if len(btn) > 10: 
            ...
            if poster:
                ...
                await message.reply_text(f"<b>Here is What I Found In My Group For Your Query pls join my movie hut group {search} ‌‌‌‌‎ ­  ­  ­  ­  ­  </b>", reply_markup=InlineKeyboardMarkup(buttons))
            return
    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('NEW MOVIES', url='https://t.me/chathurmukhamcom'),
                        InlineKeyboardButton('Join my group', url='https://t.me/movie_hut_group')
                    ]
                    ]
